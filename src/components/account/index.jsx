...
class Account extends Component {
  ...
  render() {
    const { modalOptions, selectableHobbies, selectableArtists, user } = this.state;
          ...
          <Form onSubmit={this.onSubmit}>
            ...
            <Form.Group>
              ...
              <Typeahead
                ...
                selected={user?.hobbies?.map((h) => h.hobby)}
            ...
            <Form.Group controlId="registration-receive-email">
              ...
              <Form.Check id="registration-receive-email" defaultChecked={user?.receiveMail} type="checkbox" label="Emails ontvangen" />
            </Form.Group>
            <hr />
            <Form.Group>
